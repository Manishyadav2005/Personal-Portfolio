...
/**
 * Crops an image based on pixel coordinates and rotation, returning a Blob and File.
 */
  ...
  return new Promise((resolve, reject) => {
    croppedCanvas.toBlob(
      (blob) => {
        ...
        const file = new File([blob], `cropped-moment-${Date.now()}.webp`, {
          type: "image/webp",
        });
        const dataUrl = croppedCanvas.toDataURL("image/webp", 0.92);
