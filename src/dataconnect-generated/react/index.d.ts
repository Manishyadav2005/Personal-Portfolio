import { CreateContactRequestData, CreateContactRequestVariables, ListProjectsData, UpdateSkillData, UpdateSkillVariables, GetUserData } from '../';
...
export function useCreateContactRequest(options?: useDataConnectMutationOptions<CreateContactRequestData, FirebaseError, CreateContactRequestVariables>): UseDataConnectMutationResult<CreateContactRequestData, CreateContactRequestVariables>;
export function useCreateContactRequest(dc: DataConnect, options?: useDataConnectMutationOptions<CreateContactRequestData, FirebaseError, CreateContactRequestVariables>): UseDataConnectMutationResult<CreateContactRequestData, CreateContactRequestVariables>;
